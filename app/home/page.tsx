          ...
          <div style={{ padding: '2rem 2rem 1.75rem' }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: '1.75rem', flexWrap: 'wrap' }}>
              {[
                ...
                { label: 'No charge until boxes ship', icon: <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" width={11} height={11} aria-hidden="true"><rect x="1" y="3" width="12" height="8" rx="1.5"/><path d="M1 6h12"/></svg> },
              ].map(f => (
